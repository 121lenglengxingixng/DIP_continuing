...
def save_images(targets, inputs, outputs, folder_name, epoch, num_images=5):
    """
...
def main():
    ...
    # train_loader = DataLoader(train_dataset, batch_size=4000, shuffle=True, num_workers=1)
    # val_loader = DataLoader(val_dataset, batch_size=4000, shuffle=False, num_workers=1)

    train_loader = DataLoader(train_dataset, batch_size=1024, shuffle=True, num_workers=1, pin_memory=True)
    val_loader = DataLoader(val_dataset, batch_size=1024, shuffle=False, num_workers=1, pin_memory=True)
